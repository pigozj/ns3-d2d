...
typedef struct D2dDiscoveryResource
  {
    uint16_t d2dStartFrameNo;
    uint16_t m_d2dStartFrameNo;
    uint16_t m_d2dSubFrameNo;
    uint16_t m_d2dRb;
  }D2dDiscoveryResource;
...
public:
  ...
  */
  ...
  uint32_t m_ueId;
  D2dDiscoveryResource m_d2dDiscoveryResource;
...
private:
  ...
  static uint16_t m_ueCount;
  static uint16_t m_d2dPeriodic;
  static const float m_d2dErrorRate[10] ;
  static bool m_d2dDiscoveryState[m_UeNum][m_UeNum] ;
  static uint16_t m_d2dLinkTotalNum[100];
  static uint16_t m_d2dDiscoveryNum;
  static uint16_t m_d2dTurn;
  bool m_d2dCorrupt;
